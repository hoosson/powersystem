...
<base href="${pageContext.request.scheme }://${pageContext.request.serverName }:${pageContext.request.serverPort }${pageContext.request.contextPath }/">
	...
	<body onload="getUserMsgAndMoney();">
			...
			<table class="table_class_div">
				<tr>
					<td>
						...
						<ul>充值账户&emsp;<input type="text" id="accountsId" readonly="readonly"/></ul>
						<ul>账户余额&emsp;<input type="text" id="surplusMoneyId" readonly="readonly"/></ul>
						<ul>充值金额&emsp;<input type="text" id="fullMoneyId"/></ul>
						<ul>登录密码&emsp;<input type="password" id="password"/></ul>
						<ul>
							<button onclick="insertFullMoney();">确定充值</button>&emsp;&emsp;
							<button>取消充值</button>
						</ul>
					</td>
				</tr>
